  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Dosen Penguji</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
            ...
            <div class="modal fade" id="verticalycentered" tabindex="-1">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <form action="{{ route('admin.report.examine.sk') }}" method="post">
                    @csrf
          ...
          <div class="col-12">
            <div class="card top-selling overflow-auto">
              ...
              <div class="card-body pb-0">
                <h5 class="card-title">Mahasiswa <span>| Dosen Penguji</span></h5>
                ...
                <table class="table table-borderless datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $student->Job->Company->Examiner->Lecture->nama_dosen }}</td>
                    </tr>
                    @empty
                        <tr>
