                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mt-4">
                                        <div class="">
                                            ...
                                            <span class="text-muted small pt-2">Batas Konfirmasi : </span><span class="text-warning small pt-1 fw-bold">07 November 2023</span>
                                            <div class="mt-2">
                                                <button type="button" class="btn btn-danger"><i class="bi bi-x-circle me-1"></i> Tolak</button>
                                                <button type="button" class="btn btn-success"><i class="bi bi-check-circle"></i> Terima Tawaran</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
