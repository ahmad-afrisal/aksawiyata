            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Penilaian Kerja Praktek</h5>
            
                            <!-- Floating Labels Form -->
                            <form class="row g-3" id="formD" action="{{ route('lecture.adviser.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-lg-3 col-12">
                                    ...
                                    <input type="number" class="form-control {{$errors->has('exercise_score') ? 'is-invalid' : ''}}" onchange="updateFinalScore()" value="{{ isset($adviser_score->exercise_score) ?  $adviser_score->exercise_score : ''  }}" id="exercise_score" name="exercise_score"  required>
                                ...
                                <div class="col-lg-3 col-12">
                                    ...
                                    <input type="number" class="form-control {{$errors->has('report_score') ? 'is-invalid' : ''}}" onchange="updateFinalScore()" value="{{ isset($adviser_score->report_score)  ? $adviser_score->report_score : ''}}" id="report_score" name="report_score"  required>
                                ...
                                <div class="col-lg-3 col-12">
                                    ...
                                    <input type="number" class="form-control {{$errors->has('presentation_score') ? 'is-invalid' : ''}}" onchange="updateFinalScore()" value="{{ isset($adviser_score->presentation_score) ?  $adviser_score->presentation_score : ''}}" id="presentation_score" name="presentation_score"  required>
                                    @if ($errors->has('report_score'))
                                    <div class="invalid-feedback">
                                        {{$errors->first('report_score')}}
                                    </div>
                                ...
                                <div class="col-lg-3 col-12">
                                    ...
                                    <input type="hidden" class="form-control " value="{{ isset($adviser_score->final_score) ? $adviser_score->final_score : ''}}" id="final_score" name="final_score"  required>
